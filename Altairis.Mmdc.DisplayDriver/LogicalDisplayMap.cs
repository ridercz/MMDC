...
namespace Altairis.Mmdc.DisplayDriver {
    public class LogicalDisplayMap : Dictionary<PhysicalDisplayInfo, PhysicalDisplayPosition> {

        public int Width { get; set; }

        public int Height { get; set; }

        public static LogicalDisplayMap Create(IEnumerable<PhysicalDisplayInfo> displays, IMapStrategy strategy) {
        ...
        public static LogicalDisplayMap LoadFromFile(string fileName) => LoadFromJson(File.ReadAllText(fileName));

        public static LogicalDisplayMap LoadFromJson(string json) {
            ...
            return JsonConvert.DeserializeObject<LogicalDisplayMap>(json);
        }
